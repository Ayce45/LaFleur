                    ...
                    <div class="header_top">
                        <div class="header_top_left">
                            <div class="box_11"><a href="checkout.php">
                                    <h4><p>Panier : <span id="Cart_total">0</span> € (<span id="Cart_quantity" class="simpleCart_quantity">0</span> produits)</p><img src="images/bag.png" alt=""/><div class="clearfix"> </div></h4>
                                </a>                        
                            </div> 
                        </div>
                        <?php if (isset($_SESSION['auth'])) { ?>
                            <div class="header_top_right">
                                <div class="box_11"><a href="logout.php">
                    ...
                    <div class="header_bottom">
                        ...
                        <div class="menu">
                            <ul class="megamenu skyblue">	
                                ...
                                <li><a class="color7" href="connexion.php"><i class ="fa fa-lock"></i></a></li>
